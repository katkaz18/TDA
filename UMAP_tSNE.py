...
for n in x:
    ...
    mask=nib.load(os.path.join(base_dir, line, 'functional_brain_mask/_scan_func-1/tfMRI_WM_LR_calc_resample_volreg_mask.nii.gz'))
                        


    masker = NiftiMasker(
    mask, standardize=True, detrend=True, smoothing_fwhm=4.0,
